...
def convertNotebooktoHTML(
    notebookPath, outfilePath="nb_out", template="md_not_converted"
):
    ...
    if REG_nb.match(notebook_basename):
        ...
        exporter.template_file = (
            template  # leaves markdown not converted, converts input and output cells
        )
        ...
        )  # will end up with .html extension
        ...
        for dirname in dirnames:
            ...
            if REG_nb_dir.match(dirname):
                ...
                if not os.path.exists(
                    os.path.join(os.pardir, "website", docsdir, dirname)
                ):
                ...
                for nbname in nbnames:
                    ...
                    if REG_nb.match(nbname):
                        ...
                        mdpath = os.path.join(
                            os.pardir, "website", docsdir, dirname, mdname
                        )
